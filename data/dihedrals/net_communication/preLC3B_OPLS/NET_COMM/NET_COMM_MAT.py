...
def net_comm(structure,MI_mat,source,sink):
    ...
    LC3B_II_SOURCE_vicinity=LC3B_II.select_atoms('around 3 resid %d'%source)
    LC3B_II_TARGET_vicinity=LC3B_II.select_atoms('around 3 resid %d'%sink)
    ...
    resid_all=LC3B_II.select_atoms('resid 1-125')
